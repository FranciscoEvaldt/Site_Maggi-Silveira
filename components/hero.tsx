  ...
  return (
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/elegant-law-firm-office-interior-with-dark-wood-pa.jpg"
          alt=""
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-20">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-semibold text-primary-foreground leading-tight mb-8 text-balance">
            Estratégia jurídica, atuação preventiva e atendimento humanizado.
          </h1>
          <p className="text-lg md:text-xl text-primary-foreground/80 mb-10 leading-relaxed max-w-2xl">
            No Maggi & Silveira Advogados Associados, atuamos de forma
            independente, técnica e objetiva no diagnóstico de riscos,
            estruturação de negócios jurídicos e condução estratégica de
            processos. Desenvolvemos pareceres, due diligence, acompanhamento
            preventivo e atuação direta em demandas judiciais e extrajudiciais.
          </p>
